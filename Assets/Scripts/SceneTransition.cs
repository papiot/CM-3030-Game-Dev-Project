...
public class SceneTransition : MonoBehaviour
{
    ...
    {
        GameManager.Instance.SetCampaignMode(true);  // Enable campaign mode
        SceneManager.LoadScene("1_Level 1"); // Load Level 1 for Start Campaign
    }

    public void LoadLevel1()
    {
        GameManager.Instance.SetCampaignMode(false); // Disable campaign mode
    ...
    {
        GameManager.Instance.SetCampaignMode(false); // Disable campaign mode
        SceneManager.LoadScene("2_Level 2"); // Load Level 2 for Start Level 2
    }

    public void QuitToMainMenu()
    {
        GameManager.Instance.ResetEnemiesKilled();  // Reset enemies killed when quitting to main menu
        GameManager.Instance.ResetCoinsCollected(); // Reset coins collected when quitting to main menu
